...
+ 到 DisGraFS: /web&serer/main_server 下，运行服务器端：
  ...
  <img src="image\image-20220405155150240.png" alt="image-20220405155150240" style="zoom:80%;" />
...
1. 可能会出现如下报错：
   ...
   <img src="image\image-20220408165842811.png" alt="image-20220408165842811" style="zoom:80%;" />
...
<img src="image\structure.png" alt="structure" style="zoom: 45%;" />
...
# 根据查看到的 ip 地址，打开 x-DisGraFS-main 的 ray_tagging 文件夹下的 ray_server.py，将其中的 47.119.121.73 修改为上一条指令查看到的 ip 地址
...
![image-20220408205410261](image\image-20220408205410261.png)
