...
public class Query {
    ...
    // static final String DB_URL = "jdbc:mysql://mymysql:3306/mysql?useSSL=false";
    // // docker
    ...
    public DeviceItem queryDevice(int id) {
        ...
        // //nwjadd
        // //需要写入的文件的路径
        // String filePath = "/home/nwj1804/leftrs.txt";
        // String fileContent="";
        // try{
        ...
        //             if(temp[0]==String.format("dontpanic_device_leftrs{id=%d}", id)){
        //                 fileContent+=temp[0];
        //                 fileContent+=" ";
        //                 fileContent+=Integer.toString(left);
        //                 fileContent+='\n';
        //                 old=true;
        //             }
        //             else{
        ...
        //         }
        //         if(!old){
        //             fileContent+=String.format("dontpanic_device_leftrs{id=%d} ", id);
        //             fileContent+=Integer.toString(left);
        //             fileContent+='\n';
        //         }
        //         br.close();
        ...
        //     // fileContent+="dontpanic_device_leftrs ";
        //     // fileContent+=Integer.toString(left);
        //     // fileContent+='\n';
    ...
    public int alterDevice(DeviceItem device) {
        Statement stmt = null;
        Statement monitor=null;
        ResultSet rs = null;
        int suc = -1,online_device_cnt=-1;
        try {
            stmt = conn.createStatement();
            String sql;
            if (device.isOnline())
            ...
            monitor=conn.createStatement();
            String sql1;
            sql1 = String.format("SELECT * FROM DFS.DEVICE WHERE ISONLINE=true ORDER BY RS DESC;");
            rs = monitor.executeQuery(sql1);
            rs.last();
